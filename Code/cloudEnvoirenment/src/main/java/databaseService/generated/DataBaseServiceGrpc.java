...
public final class DataBaseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<databaseService.generated.RequestMessage,
      databaseService.generated.ResponseMessage> getDataBaseDoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "dataBase_do",
      requestType = databaseService.generated.RequestMessage.class,
      responseType = databaseService.generated.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<databaseService.generated.RequestMessage,
      databaseService.generated.ResponseMessage> getDataBaseDoMethod() {
    io.grpc.MethodDescriptor<databaseService.generated.RequestMessage, databaseService.generated.ResponseMessage> getDataBaseDoMethod;
      ...
      synchronized (DataBaseServiceGrpc.class) {
        if ((getDataBaseDoMethod = DataBaseServiceGrpc.getDataBaseDoMethod) == null) {
          DataBaseServiceGrpc.getDataBaseDoMethod = getDataBaseDoMethod = 
              io.grpc.MethodDescriptor.<databaseService.generated.RequestMessage, databaseService.generated.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "dataBaseService.DataBaseService", "dataBase_do"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  databaseService.generated.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  databaseService.generated.ResponseMessage.getDefaultInstance()))
  ...
  public static abstract class DataBaseServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void dataBaseDo(databaseService.generated.RequestMessage request,
        io.grpc.stub.StreamObserver<databaseService.generated.ResponseMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                databaseService.generated.RequestMessage,
                databaseService.generated.ResponseMessage>(
  ...
  public static final class DataBaseServiceBlockingStub extends io.grpc.stub.AbstractStub<DataBaseServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<databaseService.generated.ResponseMessage> dataBaseDo(
        databaseService.generated.RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DATA_BASE_DO:
          serviceImpl.dataBaseDo((databaseService.generated.RequestMessage) request,
              (io.grpc.stub.StreamObserver<databaseService.generated.ResponseMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class DataBaseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return databaseService.generated.DataBaseServiceImpl.getDescriptor();
    }
